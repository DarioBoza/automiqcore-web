...
export function LogoIcon({ className = "w-10 h-10" }) {
  return (
    <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      {/* Gear teeth */}
      <path d="M72 30 L82 26 L86 34 L76 38Z" fill="white"/>
      <path d="M82 44 L92 42 L94 50 L84 50Z" fill="white"/>
      <path d="M82 56 L92 58 L90 66 L80 62Z" fill="white"/>
      <path d="M72 70 L80 76 L74 84 L66 76Z" fill="white"/>
      <path d="M56 78 L58 88 L50 90 L48 80Z" fill="white"/>
      <path d="M40 74 L36 84 L28 80 L34 70Z" fill="white"/>
      
      {/* Gear body (half circle on right) */}
      <path d="M50 28 A32 32 0 0 1 50 92 L50 80 A20 20 0 0 0 50 40 Z" fill="white" opacity="0.95"/>
      ...
      <circle cx="58" cy="60" r="12" fill="#010414"/>
...
export function BrandName({ className = "text-xl" }) {
  return (
    <span className={`font-bold tracking-tight ${className}`}>
      ...
      <span className="text-white">UTOM</span>
